...
public class AfterdarkNeoForgeRegistry {
    ...
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<TeleportBlockEntity>> TELEPORT_BLOCK_ENTITY = BLOCK_ENTITIES.register(TeleportBlockEntity.TELEPORT_BE_ID, () -> new BlockEntityType<>(TeleportBlockEntity::new, TELEPORT_BLOCK.get()));
