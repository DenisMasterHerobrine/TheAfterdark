...
public class LargeDarkPrismarinePillarFeature extends Feature<LargeDripstoneFeatureConfig> {
    public LargeDarkPrismarinePillarFeature(Codec<LargeDripstoneFeatureConfig> pContext) {
        super(pContext);
    }
