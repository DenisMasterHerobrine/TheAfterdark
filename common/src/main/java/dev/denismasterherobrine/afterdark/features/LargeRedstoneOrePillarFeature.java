...
public class LargeRedstoneOrePillarFeature extends Feature<LargeDripstoneFeatureConfig> {
    public LargeRedstoneOrePillarFeature(Codec<LargeDripstoneFeatureConfig> pContext) {
        super(pContext);
    }
