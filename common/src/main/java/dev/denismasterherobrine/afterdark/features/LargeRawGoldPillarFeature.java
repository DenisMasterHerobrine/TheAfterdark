...
public class LargeRawGoldPillarFeature extends Feature<LargeDripstoneFeatureConfig> {
    public LargeRawGoldPillarFeature(Codec<LargeDripstoneFeatureConfig> pContext) {
        super(pContext);
    }
