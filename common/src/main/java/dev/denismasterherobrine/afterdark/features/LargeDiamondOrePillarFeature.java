...
public class LargeDiamondOrePillarFeature extends Feature<LargeDripstoneFeatureConfig> {
    public LargeDiamondOrePillarFeature(Codec<LargeDripstoneFeatureConfig> pContext) {
        super(pContext);
    }
