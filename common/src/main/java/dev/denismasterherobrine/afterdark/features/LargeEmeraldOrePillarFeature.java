...
public class LargeEmeraldOrePillarFeature extends Feature<LargeDripstoneFeatureConfig> {
    public LargeEmeraldOrePillarFeature(Codec<LargeDripstoneFeatureConfig> pContext) {
        super(pContext);
    }
                        ...
                        if (k > 0) {
                            ...
                            for(int i1 = 0; i1 < k && blockpos$mutableblockpos.getY() < l; ++i1) {
                                ...
                                if (DripstoneHelperMixin.invokeCanGenerateOrLava(pLevel, blockpos)) {
                                    flag = true;
                                    Block block = Blocks.EMERALD_ORE;
