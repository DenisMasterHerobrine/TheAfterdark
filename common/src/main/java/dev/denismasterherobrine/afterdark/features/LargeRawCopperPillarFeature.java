...
public class LargeRawCopperPillarFeature extends Feature<LargeDripstoneFeatureConfig> {
    public LargeRawCopperPillarFeature(Codec<LargeDripstoneFeatureConfig> pContext) {
        super(pContext);
    }
                        ...
                        if (k > 0) {
                            ...
                            for(int i1 = 0; i1 < k && blockpos$mutableblockpos.getY() < l; ++i1) {
                                ...
                                if (DripstoneHelperMixin.invokeCanGenerateOrLava(pLevel, blockpos)) {
                                    flag = true;
                                    Block block = Blocks.RAW_GOLD_BLOCK;
