...
public class LargeLapisOrePillarFeature extends Feature<LargeDripstoneFeatureConfig> {
    public LargeLapisOrePillarFeature(Codec<LargeDripstoneFeatureConfig> pContext) {
        super(pContext);
    }
