...
public class LargeRawIronPillarFeature extends Feature<LargeDripstoneFeatureConfig> {
    public LargeRawIronPillarFeature(Codec<LargeDripstoneFeatureConfig> pContext) {
        super(pContext);
    }
    ...
    static final class LargePillar {
        ...
        private int getHeightAtRadius(float pRadius) {
            return (int)DripstoneHelper.scaleHeightFromRadius(pRadius, this.radius, this.scale, this.bluntness);
        }
                        ...
                        if (k > 0) {
                            ...
                            for(int i1 = 0; i1 < k && blockpos$mutableblockpos.getY() < l; ++i1) {
                                ...
                                if (DripstoneHelper.canGenerateOrLava(pLevel, blockpos)) {
                                    flag = true;
                                    Block block = Blocks.RAW_IRON_BLOCK;
